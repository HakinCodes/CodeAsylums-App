...
public final class R {
  public static final class attr {
    ...
    /**
     * The reference to the font file to be used. This should be a file in the
     * res/font folder and should therefore have an R reference value. E.g.
     * @font/myfont <p>May be a reference to another resource, in the form
    ...
    /**
     * The sets of hashes for the certificates the provider should be signed
     * with. This is used to verify the identity of the provider, and is only
     * required if the provider is not part of the system image. This value may
     * point to one list or a list of lists, where each individual list
     * represents one collection of signature hashes. Refer to your font
     * provider's documentation for these values. <p>May be a reference to
    ...
    /**
     * The strategy to be used when fetching font data from a font provider in
     * XML layouts. This attribute is ignored when the resource is loaded from
     * code, as it is equivalent to the choice of API between {@link
     * androidx.core.content.res.ResourcesCompat#getFont(Context, int)}
     * (blocking) and
     * {@link
     * androidx.core.content.res.ResourcesCompat#getFont(Context, int,
     * FontCallback, Handler)} (async). <p>Must be one of the following constant
     * values.</p> <table> <colgroup align="left" /> <colgroup align="left" />
     * <colgroup align="left" />
     * <tr><th>Constant</th><th>Value</th><th>Description</th></tr>
     * <tr><td>async</td><td>1</td><td>The async font fetch works as follows.
     * First, check the local cache, then if the requeted font is not cached,
     * trigger a request the font and continue with layout inflation. Once the
     * font fetch succeeds, the target text view will be refreshed with the
     * downloaded font data. The fontProviderFetchTimeout will be ignored if
     * async loading is specified.</td></tr>
     * <tr><td>blocking</td><td>0</td><td>The blocking font fetch works as
     * follows. First, check the local cache, then if the requested font is not
     * cached, request the font from the provider and wait until it is finished.
     * You can change the length of the timeout by modifying
     * fontProviderFetchTimeout.  If the timeout happens, the default typeface
     ...
     * <colgroup align="left" />
     * <tr><th>Constant</th><th>Value</th><th>Description</th></tr>
     * <tr><td>forever</td><td>ffffffff</td><td>A special value for the timeout.
     * In this case, the blocking font fetching will not timeout and wait until
     * a reply is received from the font provider.</td></tr>
     * </table>
     */
     ...
     * used to verify the identity of the provider. <p>May be a string value,
     * using '\\;' to escape characters such as
     * '\\n' or '\\uxxxx' for a unicode character;
     */
    public static final int fontProviderPackage = 0x7f010006;
    /**
     * The query to be sent over to the provider. Refer to your font provider's
     * documentation on the format of this string. <p>May be a string value,
     * using '\\;' to escape characters such as
     * '\\n' or '\\uxxxx' for a unicode character;
     */
    public static final int fontProviderQuery = 0x7f010007;
    /**
     * The style of the given font file. This will be used when the font is
     * being loaded into the font stack and will override any style information
     * in the font's header tables. If unspecified, the value in the font's
     * header tables will be used. <p>Must be one of the following constant
     * values.</p> <table> <colgroup align="left" /> <colgroup align="left" />
     * <colgroup align="left" />
     * <tr><th>Constant</th><th>Value</th><th>Description</th></tr>
    ...
    /**
     * The variation settings to be applied to the font. The string should be in
     * the following format: "'tag1' value1, 'tag2' value2, ...". If the default
     * variation settings should be used, or the font used does not support
     * variation settings, this attribute needs not be specified. <p>May be a
     * string value, using '\\;' to escape characters such as
     * '\\n' or '\\uxxxx' for a unicode character;
     */
    public static final int fontVariationSettings = 0x7f010009;
    /**
     * The weight of the given font file. This will be used when the font is
     * being loaded into the font stack and will override any weight information
     * in the font's header tables. Must be a positive number, a multiple of
     * 100, and between 100 and 900, inclusive. The most common values are 400
     * for regular weight and 700 for bold weight. If unspecified, the value in
     * the font's header tables will be used. <p>May be an integer value, such
     * as "<code>100</code>".
     */
    public static final int fontWeight = 0x7f01000a;
    /**
     * The index of the font in the tcc font file. If the font file referenced
     * is not in the tcc format, this attribute needs not be specified. <p>May
     * be an integer value, such as "<code>100</code>".
     */
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_android_color
     * android:color}</code></td><td></td></tr> <tr><td><code>{@link
     * #ColorStateListItem_android_alpha
     * android:alpha}</code></td><td></td></tr> <tr><td><code>{@link
     * #ColorStateListItem_alpha
     * com.example.codeasylum:alpha}</code></td><td>Alpha multiplier applied to
     * the base color.</td></tr>
     * </table>
     * @see #ColorStateListItem_android_color
     * @see #ColorStateListItem_android_alpha
     * @see #ColorStateListItem_alpha
     */
    public static final int[] ColorStateListItem = {0x010101a5, 0x0101031f,
                                                    0x7f010000};
    /**
     * <p>
     * @attr description
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name com.example.codeasylum:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority
     * com.example.codeasylum:fontProviderAuthority}</code></td><td>The
     * authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts
     * com.example.codeasylum:fontProviderCerts}</code></td><td>The sets of
     * hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy
     * com.example.codeasylum:fontProviderFetchStrategy}</code></td><td>The
     * strategy to be used when fetching font data from a font provider in XML
     * layouts.</td></tr> <tr><td><code>{@link
     * #FontFamily_fontProviderFetchTimeout
     * com.example.codeasylum:fontProviderFetchTimeout}</code></td><td>The
     * length of the timeout during fetching.</td></tr> <tr><td><code>{@link
     * #FontFamily_fontProviderPackage
     * com.example.codeasylum:fontProviderPackage}</code></td><td>The package
     * for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery
     * com.example.codeasylum:fontProviderQuery}</code></td><td>The query to be
     * sent over to the provider.</td></tr>
     * </table>
     ...
     */
    public static final int[] FontFamily = {0x7f010002, 0x7f010003, 0x7f010004,
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.codeasylum:fontProviderAuthority
     */
     ...
     * point to one list or a list of lists, where each individual list
     * represents one collection of signature hashes. Refer to your font
     * provider's documentation for these values.
     *
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.codeasylum:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name com.example.codeasylum:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name com.example.codeasylum:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.codeasylum:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.codeasylum:fontProviderQuery
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamilyFont_android_font
     * android:font}</code></td><td></td></tr> <tr><td><code>{@link
     * #FontFamilyFont_android_fontWeight
     * android:fontWeight}</code></td><td></td></tr> <tr><td><code>{@link
     * #FontFamilyFont_android_fontStyle
     * android:fontStyle}</code></td><td></td></tr> <tr><td><code>{@link
     * #FontFamilyFont_android_ttcIndex
     * android:ttcIndex}</code></td><td></td></tr> <tr><td><code>{@link
     * #FontFamilyFont_android_fontVariationSettings
     * android:fontVariationSettings}</code></td><td></td></tr>
     * <tr><td><code>{@link #FontFamilyFont_font
     * com.example.codeasylum:font}</code></td><td>The reference to the font
     * file to be used.</td></tr> <tr><td><code>{@link #FontFamilyFont_fontStyle
     * com.example.codeasylum:fontStyle}</code></td><td>The style of the given
     * font file.</td></tr> <tr><td><code>{@link
     * #FontFamilyFont_fontVariationSettings
     * com.example.codeasylum:fontVariationSettings}</code></td><td>The
     * variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight
     * com.example.codeasylum:fontWeight}</code></td><td>The weight of the given
     * font file.</td></tr> <tr><td><code>{@link #FontFamilyFont_ttcIndex
     * com.example.codeasylum:ttcIndex}</code></td><td>The index of the font in
     * the tcc font file.</td></tr>
     * </table>
    ...
    public static final int[] FontFamilyFont = {
        0x01010532, 0x01010533, 0x0101053f, 0x0101056f, 0x01010570,
        0x7f010001, 0x7f010008, 0x7f010009, 0x7f01000a, 0x7f01000b};
    /**
     ...
     * android.R.attr#fontVariationSettings} attribute's value can be found in
     * the {@link #FontFamilyFont} array.
     *
     * <p>May be a string value, using '\\;' to escape characters such as
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.codeasylum:font
     */
     ...
     * </table>
     *
     * @attr name com.example.codeasylum:fontStyle
     */
     ...
     * the following format: "'tag1' value1, 'tag2' value2, ...". If the default
     * variation settings should be used, or the font used does not support
     * variation settings, this attribute needs not be specified.
     *
     * <p>May be a string value, using '\\;' to escape characters such as
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.codeasylum:fontVariationSettings
     */
     ...
     * 100, and between 100 and 900, inclusive. The most common values are 400
     * for regular weight and 700 for bold weight. If unspecified, the value in
     * the font's header tables will be used.
     *
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.example.codeasylum:fontWeight
     */
     ...
     * @attr description
     * The index of the font in the tcc font file. If the font file referenced
     * is not in the tcc format, this attribute needs not be specified.
     *
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.example.codeasylum:ttcIndex
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #GradientColor_android_startColor
     * android:startColor}</code></td><td></td></tr> <tr><td><code>{@link
     * #GradientColor_android_endColor
     * android:endColor}</code></td><td></td></tr> <tr><td><code>{@link
     * #GradientColor_android_type android:type}</code></td><td></td></tr>
     * <tr><td><code>{@link #GradientColor_android_centerX
     * android:centerX}</code></td><td></td></tr> <tr><td><code>{@link
     * #GradientColor_android_centerY android:centerY}</code></td><td></td></tr>
     * <tr><td><code>{@link #GradientColor_android_gradientRadius
     * android:gradientRadius}</code></td><td></td></tr> <tr><td><code>{@link
     * #GradientColor_android_tileMode
     * android:tileMode}</code></td><td></td></tr> <tr><td><code>{@link
     * #GradientColor_android_centerColor
     * android:centerColor}</code></td><td></td></tr> <tr><td><code>{@link
     * #GradientColor_android_startX android:startX}</code></td><td></td></tr>
     * <tr><td><code>{@link #GradientColor_android_startY
     * android:startY}</code></td><td></td></tr> <tr><td><code>{@link
     * #GradientColor_android_endX android:endX}</code></td><td></td></tr>
     * <tr><td><code>{@link #GradientColor_android_endY
     * android:endY}</code></td><td></td></tr>
     * </table>
    ...
    public static final int[] GradientColor = {
        0x0101019d, 0x0101019e, 0x010101a1, 0x010101a2, 0x010101a3, 0x010101a4,
        0x01010201, 0x0101020b, 0x01010510, 0x01010511, 0x01010512, 0x01010513};
    /**
     * <p>
     * @attr description
     ...
     *
     * <p>May be a floating point value, such as "<code>1.2</code>".
     * <p>May be a fractional value, which is a floating point number appended
     * with either % or %p, such as "<code>14.5%</code>". The % suffix always
     * means a percentage of the base size; the optional %p suffix provides a
     * size relative to some parent container.
     *
     ...
     *
     * <p>May be a floating point value, such as "<code>1.2</code>".
     * <p>May be a dimension value, which is a floating point number appended
     ...
     * preferred font size), in (inches), and mm (millimeters). <p>May be a
     * fractional value, which is a floating point number appended with either %
     * or %p, such as "<code>14.5%</code>". The % suffix always means a
     ...
     * <p>
     * @attr description
     * Defines the tile mode of the gradient. SweepGradient doesn't support
     * tiling.
     *
     * <p>Must be one of the following constant values.</p>
     * <table>
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #GradientColorItem_android_color
     * android:color}</code></td><td></td></tr> <tr><td><code>{@link
     * #GradientColorItem_android_offset
     * android:offset}</code></td><td></td></tr>
     * </table>
